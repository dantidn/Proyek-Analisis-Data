...
def calculate_total_registered(day_data):
    """Calculate total registered bikes per day."""
...
def calculate_total_casual(day_data):
    """Calculate total casual bikes per day."""
...
# Filter main datasets based on selected date range
...
st.caption("Berdasarkan visualisasi data, terlihat jelas bahwa puncak aktivitas penyewaan sepeda terjadi pada pukul 17.00. Sebaliknya, permintaan akan sepeda mencapai titik terendahnya pada pukul 04.00.")

# Plot for busy rental hours
...
ax[0].set_title("Hours with Highest Bike Rentals", loc="center", fontsize=30)
ax[0].tick_params(axis='y', labelsize=35)
ax[0].tick_params(axis='x', labelsize=30)

# Plot for less busy rental hours
...
ax[1].set_title("Hours with Lowest Bike Rentals", loc="center", fontsize=30)
ax[1].invert_xaxis()
...
# Pie chart for user contributions
